class DataValues {
  ...
  static Uri githubURL = Uri.parse('https://github.com/kmlinn');
  static Uri linkedinURL = Uri.parse('https://linkedin.com/in/kmlinn');
  static Uri twitterURL = Uri.parse('https://twitter.com/kmlinn');
  static Uri youtubeURL = Uri.parse('https://youtube.com/@flutterscopekmlinn');
  static Uri telegramURL = Uri.parse('https://t.me/kmlinn');
  static Uri facebookURL = Uri.parse('https://facebook.com/kmlinn');
  static Uri instagramURL = Uri.parse('https://instagram.com/kmlinn');
  static Uri repoURL =
      Uri.parse('https://github.com/kmlinn.dev');
  ...
  static const String aboutMeNwIDescription = 'Kaung Myat Linn';
  static const String aboutMeFnLTitle = 'First and Last Name';
  static const String aboutMeFnLDescription = 'Kaung Myat Linn';
  ...
  static const String experienceOrg1Title = 'Kaung Myat Linn';
  ...
  static const String copyright =
      "Copyright ©2023 Kaung Myat Linn. All Rights Reserved.";
